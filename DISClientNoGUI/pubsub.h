...
public:
    ...
    void start();
    void stop();
    void setPubTopic(const std::string& topic, std::shared_ptr<google::protobuf::Message> msg);
    void setSubTopic(const std::string& topic, std::shared_ptr<google::protobuf::Message> msg);
    std::shared_ptr<google::protobuf::Message> getPubTopic(const std::string& topic);
    std::shared_ptr<google::protobuf::Message> getSubTopic(const std::string& topic);
...
private:
    ...
    void handle_synpub();
    std::map<std::string, std::shared_ptr<google::protobuf::Message>> publish_topic_proto_map_; 
    std::map<std::string, std::shared_ptr<google::protobuf::Message>> subscribe_topic_proto_map_;
